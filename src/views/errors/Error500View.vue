...
<template>
  ...
  >
    ...
    >
      <div
        class="err-icon-tile grid h-12 w-12 place-items-center rounded-md bg-line-2 text-amber-300"
      >
        <KovaIcon name="alert-triangle" size="lg" />
      </div>
      <h1 class="text-xl font-semibold">Something broke</h1>
      <p class="text-sm text-ink-2">Try again in a moment.</p>
