...
The PRD lives at `kova-open-pencil-1/docs/prd/02-onboarding-and-dashboard.md`. Every PRD section maps to one or more tasks below:
...
Plan saved to `kova-open-pencil-1/docs/plans/02-onboarding-and-dashboard-plan.md`.
