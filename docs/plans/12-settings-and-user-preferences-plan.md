...
**PRD reference:** `/Users/jihoyang/kova-main/kova-open-pencil-1/docs/prd/12-settings-and-user-preferences.md`
...
| File | Purpose |
|---|---|
| `docs/prd/00-PRD_SCOPE_PLAN.md` | MODIFY — bump Cluster 12 row in §7 to `IN-DRAFT` / `IN-REVIEW` after PRD founder review. |
| `docs/prd/00a-PRD_AUTHORING_GUIDE.md` | MODIFY — bump Cluster 12 tracker row with author + date. |
...
Open `kova-open-pencil-1/docs/plans/04-account-and-stripe-billing-plan.md` and append at the Profile-section task:
...
```bash
git add ../kova-open-pencil-1/docs/plans/04-account-and-stripe-billing-plan.md
...
**Files:**
- Modify: `docs/prd/00-PRD_SCOPE_PLAN.md`
- Modify: `docs/prd/00a-PRD_AUTHORING_GUIDE.md`
...
In `docs/prd/00-PRD_SCOPE_PLAN.md`, find Cluster 12 in the dependencies/tracker table; bump status to `APPROVED` (after founder review) or `IN-IMPLEMENTATION`.

- [ ] **Step 3: Update PRD authoring guide tracker**

In `docs/prd/00a-PRD_AUTHORING_GUIDE.md §7`, change the Cluster 12 row from `PENDING / — / —` to:
...
```bash
git add docs/prd/00-PRD_SCOPE_PLAN.md docs/prd/00a-PRD_AUTHORING_GUIDE.md docs/legal/privacy-policy.md
...
Plan complete and saved to `kova-open-pencil-1/docs/plans/12-settings-and-user-preferences-plan.md`. Two execution options:
