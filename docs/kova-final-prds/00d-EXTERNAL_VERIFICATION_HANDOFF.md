...
- `docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md` — the comprehensive audit this handoff responds to (2,585 lines).
- `docs/kova-final-prds/00-PRD_SCOPE_PLAN.md` — the 12-cluster / 6-wave PRD plan (see esp. §5.5 + §5.6 ratification log).
