...
- **No code touched** during dispatch phase — only `docs/kova-final-prds/*.md` + `docs/kova-final-impl-plans/*.md`.
...
- Does NOT modify any file outside `docs/kova-final-prds/NN-slug.md` and `docs/kova-final-impl-plans/NN-slug-plan.md`.
...
1. `kova-open-pencil-1/docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md` — operator manual
2. `kova-open-pencil-1/docs/kova-final-prds/00-PRD_SCOPE_PLAN.md` — full doc (focus your §3 Cluster NN subsection)
3. `kova-open-pencil-1/docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md` — focus your §2.A Cluster NN block (line range cited per cluster below)
4. `kova-open-pencil-1/docs/kova-final-prds/01-auth-and-identity.md` — **canonical reference PRD**. Match this depth, structure, and tone.
5. `kova-open-pencil-1/docs/kova-final-prds/00d-EXTERNAL_VERIFICATION_HANDOFF.md` + `00e-EXTERNAL_VERIFICATION_VERDICT.md` — for cross-cuts + hygiene rules
...
- PRD: `kova-open-pencil-1/docs/kova-final-prds/NN-slug.md` (status `DRAFT`)
- Plan: `kova-open-pencil-1/docs/kova-final-impl-plans/NN-slug-plan.md` (output of `superpowers:writing-plans` skill consuming the PRD)
...
- Commit anything
- Push to remote
- Modify any file outside `docs/kova-final-prds/NN-slug.md` and `docs/kova-final-impl-plans/NN-slug-plan.md`
...
Do not redispatch. PRD at `docs/kova-final-prds/01-auth-and-identity.md`. Plan generation pending (next step: founder runs `superpowers:writing-plans` against the PRD).
...
1. /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 02)
3. /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1105–1182 = §2.A Cluster 02)
4. /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/01-auth-and-identity.md (canonical reference — match depth and structure)
5. /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/00d-EXTERNAL_VERIFICATION_HANDOFF.md
6. /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/00e-EXTERNAL_VERIFICATION_VERDICT.md
...
OUTPUT:
1. PRD at /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-prds/02-onboarding-and-dashboard.md (status DRAFT, per template at 00-PRD_SCOPE_PLAN.md §5)
2. Implementation plan via superpowers:writing-plans skill — output to /Users/jihoyang/kova-main/kova-open-pencil-1/docs/kova-final-impl-plans/02-onboarding-and-dashboard-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 03)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1183–1271 = §2.A Cluster 03)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
5. docs/kova-final-prds/00d + 00e (verification context)
...
OUTPUT:
1. PRD at docs/kova-final-prds/03-brand-management.md (status DRAFT)
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/03-brand-management-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 04 + §5.5 M9 cross-cut)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1272–1403 = §2.A Cluster 04 + §1.E.1 Shopify M9 audit)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference; this PRD CONSUMES <DangerZoneCard> shipped by 01)
5. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/04-account-and-stripe-billing.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/04-account-and-stripe-billing-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 05)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1404–1550 = §2.A Cluster 05 + §1.E.1 brand-kit-extract analysis)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
5. docs/kova-final-prds/00d + 00e (PARTICULARLY 00e §6 #5 — voice-draft guardrail)
...
OUTPUT:
1. PRD at docs/kova-final-prds/05-brand-kit-and-drag-drop.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/05-brand-kit-and-drag-drop-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 06)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1551–1613 = §2.A Cluster 06)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
5. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/06-canvas-editor-core-chrome.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/06-canvas-editor-core-chrome-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 07)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1614–1683 = §2.A Cluster 07; lift the 1a + 1b buckets)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
5. CLAUDE.md (root) — sections "Never modify" + "lift the core lock per amendment"
6. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/07a-canvas-engine-core-renderer.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/07a-canvas-engine-core-renderer-plan.md
...
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 07)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1614–1683 — buckets 1c + 1d)
4. docs/kova-final-prds/07a-canvas-engine-core-renderer.md (sibling PRD — read after it lands to verify scope split)
5. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
6. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/07b-canvas-engine-inspector-overlays.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/07b-canvas-engine-inspector-overlays-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 08)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1684–1763 = §2.A Cluster 08)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
5. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/08-canvas-menus-popovers-shortcuts.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/08-canvas-menus-popovers-shortcuts-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 09)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1764–1945 = §2.A Cluster 09 — biggest single per-cluster spec; lift liberally)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference; 09 STORAGE cascade deletion paths handed to 01's cron)
5. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/09-version-history-and-trash.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/09-version-history-and-trash-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 10)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 1946–2007 = §2.A Cluster 10 + §1.E.1 Shopify M9 5-tool audit)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference)
...
OUTPUT:
1. PRD at docs/kova-final-prds/10-ai-chat-and-memory.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/10-ai-chat-and-memory-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 11 + §6 cross-cuts table — every primitive listed there ships from this PRD)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 2008–2057 = §2.A Cluster 11)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference; 01 CONSUMES this PRD's primitives heavily — read its §11 cross-cuts table)
5. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/11-shared-ui-infrastructure.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/11-shared-ui-infrastructure-plan.md
...
REQUIRED READING:
1. docs/kova-final-prds/00a-PRD_AUTHORING_GUIDE.md
2. docs/kova-final-prds/00-PRD_SCOPE_PLAN.md (focus §3 Cluster 12)
3. docs/kova-final-prds/00c-COMPREHENSIVE_AUDIT_REPORT.md (focus lines 2058–2128 = §2.A Cluster 12)
4. docs/kova-final-prds/01-auth-and-identity.md (canonical reference; users.preferences column ships there — this PRD CONSUMES it)
5. docs/kova-final-prds/00d + 00e
...
OUTPUT:
1. PRD at docs/kova-final-prds/12-settings-and-user-preferences.md
2. Plan via superpowers:writing-plans → docs/kova-final-impl-plans/12-settings-and-user-preferences-plan.md
