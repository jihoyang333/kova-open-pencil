...
- **No code touched** during dispatch phase — only `docs/prd/*.md` + `docs/plans/*.md`.
...
- Does NOT modify any file outside `docs/prd/NN-slug.md` and `docs/plans/NN-slug-plan.md`.
...
- Plan: `kova-open-pencil-1/docs/plans/NN-slug-plan.md` (output of `superpowers:writing-plans` skill consuming the PRD)
...
- Commit anything
- Push to remote
- Modify any file outside `docs/prd/NN-slug.md` and `docs/plans/NN-slug-plan.md`
...
2. Implementation plan via superpowers:writing-plans skill — output to /Users/jihoyang/kova-main/kova-open-pencil-1/docs/plans/02-onboarding-and-dashboard-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/03-brand-management-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/04-account-and-stripe-billing-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/05-brand-kit-and-drag-drop-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/06-canvas-editor-core-chrome-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/07a-canvas-engine-core-renderer-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/07b-canvas-engine-inspector-overlays-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/08-canvas-menus-popovers-shortcuts-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/09-version-history-and-trash-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/10-ai-chat-and-memory-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/11-shared-ui-infrastructure-plan.md
...
2. Plan via superpowers:writing-plans → docs/plans/12-settings-and-user-preferences-plan.md
