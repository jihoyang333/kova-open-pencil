...
in `docs/prd/00c-COMPREHENSIVE_AUDIT_REPORT.md §895` permits Kova-side mods
...
- `kova-open-pencil-1/docs/prd/00-PRD_SCOPE_PLAN.md` (master plan; §3 Cluster 07; §5.6 item 10 split-commit; §6 cross-cuts; §8 done definition)
- `kova-open-pencil-1/docs/prd/00a-PRD_AUTHORING_GUIDE.md` (operator manual followed for this draft)
- `kova-open-pencil-1/docs/prd/00c-COMPREHENSIVE_AUDIT_REPORT.md` (§2.A Cluster 07 lines 1614–1683 — items 1–8 lifted; items 9–11 re-scoped to 07a per §12.1; §895 core-lock amendment ratification)
- `kova-open-pencil-1/docs/prd/00d-EXTERNAL_VERIFICATION_HANDOFF.md` (D-10 PRD 07 split ratification)
- `kova-open-pencil-1/docs/prd/00e-EXTERNAL_VERIFICATION_VERDICT.md` (Figma SLICE / MEASUREMENT / mask verification log; §6 PRD-hygiene rules)
