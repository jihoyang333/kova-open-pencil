...
>
> **Output: ONE comprehensive report** at `kova-open-pencil-1/docs/prd/00c-COMPREHENSIVE_AUDIT_REPORT.md`. Your report becomes the **decision-input** the founder ratifies before PRD authoring begins. PRDs then author against ratified decisions — not invented ones.
...
/Users/jihoyang/kova-main/kova-open-pencil-1/docs/prd/00-PRD_SCOPE_PLAN.md
```
...
Save to: `/Users/jihoyang/kova-main/kova-open-pencil-1/docs/prd/00c-COMPREHENSIVE_AUDIT_REPORT.md`
...
1. **READ-ONLY.** The only file you write is the audit report at `kova-open-pencil-1/docs/prd/00c-COMPREHENSIVE_AUDIT_REPORT.md`. No edits to any other file.
