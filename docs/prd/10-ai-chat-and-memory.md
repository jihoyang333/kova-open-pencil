...
- `kova-open-pencil-1/docs/prd/00-PRD_SCOPE_PLAN.md` §3 Cluster 10 + §5 template + §5.5 M9 reuse table + §5.6 audit ratification log
- `kova-open-pencil-1/docs/prd/00a-PRD_AUTHORING_GUIDE.md` (operator manual followed for this draft)
- `kova-open-pencil-1/docs/prd/00c-COMPREHENSIVE_AUDIT_REPORT.md` (§2.A Cluster 10 lines 1946–2007 lifted as base + §1.E.1 Check 5 no-connection error UX gap)
- `kova-open-pencil-1/docs/prd/00d-EXTERNAL_VERIFICATION_HANDOFF.md` (D-3 AI guardrail; D-5 cross-cutting picks)
- `kova-open-pencil-1/docs/prd/00e-EXTERNAL_VERIFICATION_VERDICT.md` (§6 PRD-hygiene rules; §8 resolved-concerns log; multi-device-sync caveat)
