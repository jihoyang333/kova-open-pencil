interface ParsedRow { table: string; record: Record<string, unknown> }

export async function* parseBulkJsonl(source: string | ReadableStream<Uint8Array>): AsyncGenerator<ParsedRow> {
